...
test_names = [
    "Protein Shake Powder", "Cheese Pizza Slice", "Strawberry Smoothie",
    "Chocolate Croissant", "Greek Yogurt Bowl"
]
...
# Protein Shake Powder: prob=1.00, level=10/10, Healthy
# Cheese Pizza Slice: prob=0.00, level=0/10, Not Healthy
# Strawberry Smoothie: prob=0.75, level=7/10, Healthy
# Chocolate Croissant: prob=0.00, level=0/10, Not Healthy
# Greek Yogurt Bowl: prob=0.81, level=8/10, Healthy

# Overall accuracy over 50 runs: 97.2% (243/250)
